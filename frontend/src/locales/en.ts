export const en = {
  ...
  'landing.hero.title1':      'Your store already knows what to do tomorrow.',
  'landing.hero.title2':      'Sillages tells you.',
  'landing.hero.body':        'Every morning, a brief built from your store\u2019s real patterns. What slowed down. Who\u2019s about to come back. What to do today.',
  ...
  'landing.feature1.title':   'Learns your store\u2019s patterns over time',
  'landing.feature2.title':   'Detects what\u2019s urgent before you have to ask',
  'landing.feature3.title':   'One-click actions directly from the brief',
  'landing.feature4.title':   'Cart recovery, welcome emails, reactivation \u2014 automatic',
