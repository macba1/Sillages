export const en = {
  ...
  'landing.badge':            'AI-powered growth for Shopify',
  'landing.hero.title1':      'Your AI growth team',
  'landing.hero.title2':      'for Shopify.',
  'landing.hero.body':        'Sillages analyzes your store, finds opportunities, and executes growth actions. You just approve.',
  'landing.cta.trial':        'Start free trial',
  'landing.cta.howItWorks':   'See how it works \u2192',
  'landing.what.label':       'What you get',
  'landing.prop1.label':      'Smart Insights',
  'landing.prop1.desc':       'Daily briefs with real numbers, customer patterns, and product trends. Know exactly what happened and what to do next.',
  'landing.prop2.label':      'Automated Actions',
  'landing.prop2.desc':       'Cart recovery emails, welcome sequences, reactivation campaigns. AI writes the copy using your brand voice. You just approve.',
  'landing.prop3.label':      'Customer Intelligence',
  'landing.prop3.desc':       'Know who your best customers are, who is about to buy again, and who you are losing. Real names, real data, real opportunities.',
