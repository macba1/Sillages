export const en = {
  ...
  'landing.badge':            'AI-powered emails for Shopify',
  'landing.hero.title1':      'Recover abandoned carts',
  'landing.hero.title2':      'with emails that sound like you.',
  'landing.hero.body':        'Sillages sends cart recovery and welcome emails using your brand voice. Plus a daily intelligence brief so you always know what\u2019s happening in your store.',
  ...
  'landing.features.title':   'Everything you need to grow your store.',
  'landing.feature1.title':   'Cart Recovery Emails',
  'landing.feature1.desc':    'Automatically email customers who abandoned their cart. AI writes personalized copy using your brand voice \u2014 no templates, no generic messages.',
  'landing.feature2.title':   'Welcome Emails',
  'landing.feature2.desc':    'Greet new customers with a warm, on-brand welcome email. Build loyalty from the first purchase.',
  'landing.feature3.title':   'Daily Intelligence Brief',
  'landing.feature3.desc':    'Every morning, get a written brief about what happened in your store yesterday \u2014 revenue, top products, customer patterns, and what to do next.',
  ...
  'landing.pricing.starter.f1':  'Daily intelligence brief',
  ...
  'landing.pricing.growth.f1':  'Everything in Starter',
  'landing.pricing.growth.f2':  'Cart recovery emails',
  'landing.pricing.growth.f3':  'Welcome emails',
  'landing.pricing.growth.f4':  'Brand voice customization',
  'landing.pricing.growth.f5':  '14-day free trial',
  'landing.pricing.growth.cta': 'Start 14-day trial',

  'landing.pricing.pro.f1':  'Everything in Growth',
  'landing.pricing.pro.f2':  'Advanced analytics',
  'landing.pricing.pro.f3':  'Commercial calendar',
  'landing.pricing.pro.f4':  'Priority support',
  'landing.pricing.pro.cta': 'Start 14-day trial',

  'landing.pricing.scale.f1':  'Everything in Pro',
  'landing.pricing.scale.f2':  'Multi-store (up to 3)',
  'landing.pricing.scale.f3':  'API access',
  'landing.pricing.scale.f4':  'Dedicated success manager',
  'landing.pricing.scale.cta': 'Start 14-day trial',

  'landing.bottom.title':    'Ready to grow your store?',
  'landing.bottom.desc':     'Install Sillages and get your first intelligence brief tomorrow morning.',
  ...
  'landing.card.body':         'I tracked $4,820 across 38 orders yesterday \u2014 your Vitamin C Serum carried the day, but only 3 out of every 100 visitors actually bought something, and I think I know exactly why.',
  'landing.card.sectionLabel': 'ONE THING TO DO TODAY',
  'landing.card.action':       "Send a follow-up email to everyone who looked at the Serum page yesterday but didn\u2019t buy. I\u2019ll tell you exactly what to write.",
  'landing.card.footer':       "Tonight I\u2019ll pull today\u2019s data. Tomorrow\u2019s brief ready by 6am.",
