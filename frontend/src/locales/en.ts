export const en = {
  ...
  'settings.plan.free':              'Current plan',
  'settings.plan.freeDesc':          'Manage your plan from Shopify \u2192 Settings \u2192 Apps.',

  'settings.account.emailDesc':      'Your account email.',
  'settings.account.signOut':        'Sign out',

  'settings.badge.beta':             'Active',
  ...
  'landing.nav.install':      'Install on Shopify',
  'landing.badge':            'The daily brief for Shopify stores',
  'landing.hero.title1':      'The operations director',
  'landing.hero.title2':      'your store can\u2019t afford.',
  'landing.hero.body':        'Every morning, a brief that tells you what happened in your store yesterday and what to do today \u2014 in plain language, built on YOUR business\u2019s memory.',
  'landing.cta.install':      'Install on Shopify \u2014 Free',
  'landing.cta.howItWorks':   'See a real brief \u2192',
  'landing.hero.trust':       'Powered by AI \u00b7 Trusted by Shopify merchants \u00b7 Billed through Shopify',

  'landing.why.h2':           'Why not just ask ChatGPT?',
  'landing.why.p1':           'You could. But ChatGPT doesn\u2019t know Wednesdays are your best day. It doesn\u2019t know Mar\u00eda has bought 4 times and should be VIP. It doesn\u2019t know your brioche usually sells out in 2 days and hasn\u2019t moved in 4.',
  'landing.why.p2':           'Sillages lives inside your store. Every day it runs, it knows your business better. That memory can\u2019t be copied, exported, or asked from a generic AI.',
  'landing.why.p3':           'You don\u2019t ask. Sillages tells you.',

  'landing.features.label':   'What you get',
  'landing.features.title':   'The brief, and the actions it recommends.',
  'landing.feature1.title':   'The Daily Brief',
  'landing.feature1.desc':    'Every morning at 7:00, what happened and what to do. No dashboards, nothing to dig for.',
  'landing.feature2.title':   'Your Business\u2019s Memory',
  'landing.feature2.desc':    'Learns YOUR store\u2019s patterns: your best days, your repeat customers, your products that stall.',
  'landing.feature3.title':   'One-Click Actions',
  'landing.feature3.desc':    'The brief doesn\u2019t just inform. It proposes the action with the copy already written. You approve, Sillages executes: cart recovery, welcomes, reactivations.',

  'landing.pricing.label':    'Pricing',
  'landing.pricing.title':    'Simple, transparent pricing.',
  'landing.pricing.subtitle': 'Start free, upgrade when you\u2019re ready. All paid plans include a 14-day free trial.',
  'landing.pricing.free':     'Free forever',
  'landing.pricing.note':     'All billing managed securely through Shopify. Cancel anytime by uninstalling.',

  'landing.pricing.starter.f1':  'The basic brief, every morning',
  'landing.pricing.starter.f2':  'Store dashboard',
  'landing.pricing.starter.f3':  'Basic analytics',
  'landing.pricing.starter.cta': 'Install Free',

  'landing.pricing.basico.f1':  'The full brief with memory + brand voice',
  'landing.pricing.basico.f2':  'Everything in Starter',
  'landing.pricing.basico.f3':  'Trends & recommendations',
  'landing.pricing.basico.f4':  'Brand voice customization',
  'landing.pricing.basico.cta': 'Start 14-day trial',

  'landing.pricing.crecimiento.f1':  'Brief + automatic actions (cart recovery)',
  'landing.pricing.crecimiento.f2':  'Everything in B\u00e1sico',
  'landing.pricing.crecimiento.f3':  'Push notifications',
  'landing.pricing.crecimiento.cta': 'Start 14-day trial',

  'landing.pricing.pro.f1':  'Brief + all actions (welcome, reactivation)',
  'landing.pricing.pro.f2':  'Everything in Crecimiento',
  'landing.pricing.pro.f3':  'Priority support',
  'landing.pricing.pro.cta': 'Start 14-day trial',

  'landing.bottom.title':    'Install today.',
  'landing.bottom.desc':     'Tomorrow at 7:00 you get your first brief.',
  'landing.bottom.cta':      'Install on Shopify',
  ...
  'landing.card.date':         'TUESDAY, JUNE 9 \u00b7 2026',
  'landing.card.active':       'Active',
  'landing.card.greeting':     'Good morning, Tony.',
  'landing.card.body':         'Yesterday: \u20ac482 across 12 orders. Solid Tuesday \u2014 23% above your Tuesday average.',
  'landing.card.sectionLabel': 'WHAT I\u2019M SEEING TODAY',
  'landing.card.action':       "\u26a0\ufe0f The Tasting Pack hasn\u2019t sold in 5 days. It usually moves every 2 \u2014 check it\u2019s visible on your home page.\n\n\u2b50 Laura G. just made her 4th purchase. Time to treat her as VIP \u2014 I have a thank-you email ready, approve it with one click.",
  'landing.card.footer':       "Tomorrow at 7:00 I\u2019ll tell you how today went.",

  // ── Onboarding ───────────────────────────────────────────────────────────────
  'onboarding.welcome.hi':     'Hi {firstName},',
  'onboarding.welcome.sub':    "I\u2019m Sillages \u2014 your personal store agent.",
  'onboarding.welcome.body':   "I know exactly how you feel. We have a store, we see the numbers, but we don\u2019t really understand why some days go well and others don\u2019t. Too much data, too many screens, too many things we\u2019re supposedly supposed to be doing. I take care of that.",
  'onboarding.step1':          "Every morning I\u2019ll tell you what happened in our store",
  'onboarding.step2':          'I work every night while you sleep \u2014 no setup needed',
  'onboarding.step3':          'I just need read-only access to our Shopify store to get started',
  'onboarding.cta':            "Let\u2019s get to work \u2192",
  'onboarding.beta':           'Free plan available \u00b7 No credit card \u00b7 Cancel anytime',
