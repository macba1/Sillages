...
export const translations: Translations = {
  ...
  'landing.badge':            'Emails con IA para Shopify',
  'landing.hero.title1':      'Recupera carritos abandonados',
  'landing.hero.title2':      'con emails que suenan como tú.',
  'landing.hero.body':        'Sillages envía emails de recuperación de carritos y bienvenida usando la voz de tu marca. Además, un informe de inteligencia diario para que siempre sepas qué pasa en tu tienda.',
  ...
  'landing.features.title':   'Todo lo que necesitas para crecer tu tienda.',
  'landing.feature1.title':   'Emails de Carrito Abandonado',
  'landing.feature1.desc':    'Envía automáticamente emails a clientes que abandonaron su carrito. La IA escribe textos personalizados con la voz de tu marca \u2014 sin plantillas, sin mensajes genéricos.',
  'landing.feature2.title':   'Emails de Bienvenida',
  'landing.feature2.desc':    'Da la bienvenida a nuevos clientes con un email cálido y con tu estilo. Construye fidelidad desde la primera compra.',
  'landing.feature3.title':   'Informe de Inteligencia Diario',
  'landing.feature3.desc':    'Cada mañana, recibe un informe escrito sobre qué pasó en tu tienda ayer \u2014 ingresos, productos top, patrones de clientes y qué hacer.',
  ...
  'landing.pricing.starter.f1':  'Informe de inteligencia diario',
  ...
  'landing.pricing.growth.f1':  'Todo lo de Starter',
  'landing.pricing.growth.f2':  'Emails de carrito abandonado',
  'landing.pricing.growth.f3':  'Emails de bienvenida',
  'landing.pricing.growth.f4':  'Personalización de voz de marca',
  'landing.pricing.growth.f5':  '14 días gratis',
  'landing.pricing.growth.cta': 'Empezar 14 días gratis',

  'landing.pricing.pro.f1':  'Todo lo de Growth',
  'landing.pricing.pro.f2':  'Analítica avanzada',
  'landing.pricing.pro.f3':  'Calendario comercial',
  'landing.pricing.pro.f4':  'Soporte prioritario',
  'landing.pricing.pro.cta': 'Empezar 14 días gratis',

  'landing.pricing.scale.f1':  'Todo lo de Pro',
  'landing.pricing.scale.f2':  'Multi-tienda (hasta 3)',
  'landing.pricing.scale.f3':  'Acceso API',
  'landing.pricing.scale.f4':  'Manager de éxito dedicado',
  'landing.pricing.scale.cta': 'Empezar 14 días gratis',

  'landing.bottom.title':    '¿Listo para hacer crecer tu tienda?',
  'landing.bottom.desc':     'Instala Sillages y recibe tu primer informe de inteligencia mañana por la mañana.',
