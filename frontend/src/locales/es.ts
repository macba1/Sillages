...
export const translations: Translations = {
  ...
  'landing.badge':            'Crecimiento con IA para Shopify',
  'landing.hero.title1':      'Tu equipo de crecimiento',
  'landing.hero.title2':      'con IA para Shopify.',
  'landing.hero.body':        'Sillages analiza tu tienda, encuentra oportunidades y ejecuta acciones de crecimiento. Tú solo apruebas.',
  'landing.cta.trial':        'Empezar gratis',
  'landing.cta.howItWorks':   'Ver cómo funciona \u2192',
  'landing.what.label':       'Qué obtienes',
  'landing.prop1.label':      'Insights Inteligentes',
  'landing.prop1.desc':       'Informes diarios con datos reales, patrones de clientes y tendencias de productos. Sabe exactamente qué pasó y qué hacer.',
  'landing.prop2.label':      'Acciones Automatizadas',
  'landing.prop2.desc':       'Emails de carrito abandonado, bienvenida a nuevos clientes, campañas de reactivación. La IA escribe con la voz de tu marca. Tú solo apruebas.',
  'landing.prop3.label':      'Inteligencia de Clientes',
  'landing.prop3.desc':       'Conoce quiénes son tus mejores clientes, quién está a punto de volver a comprar y a quién estás perdiendo. Nombres reales, datos reales, oportunidades reales.',
