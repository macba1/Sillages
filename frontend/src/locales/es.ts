...
export const translations: Translations = {
  ...
  'landing.hero.title1':      'Tu tienda ya sabe qué hacer mañana.',
  'landing.hero.title2':      'Sillages te lo dice.',
  'landing.hero.body':        'Cada mañana, un brief construido desde los patrones reales de tu tienda. Qué frenó. Quién está a punto de volver. Qué hacer hoy.',
  ...
  'landing.feature1.title':   'Aprende los patrones de tu tienda con el tiempo',
  'landing.feature2.title':   'Detecta lo urgente antes de que tengas que preguntar',
  'landing.feature3.title':   'Acciones a un clic directamente desde el brief',
  'landing.feature4.title':   'Recovery de carritos, bienvenidas, reactivación — automático',
