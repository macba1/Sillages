...
const PLANS = [
  {
    ...
    price: 0,
    period: 'Free forever',
    description: 'Get started with your daily intelligence brief.',
    features: [
  ...
  },
  {
    ...
    price: 29,
    period: '/month',
    description: 'Recover abandoned carts and welcome new customers automatically.',
    features: [
  ...
  },
  {
    ...
    price: 79,
    period: '/month',
    description: 'Full automation with reactivation and growth tools.',
    features: [
  ...
  },
  {
    ...
    price: 199,
    period: '/month',
    description: 'Enterprise features for high-volume stores.',
    features: [
      'Everything in Pro',
      'Instagram posting',
      'WhatsApp Business',
